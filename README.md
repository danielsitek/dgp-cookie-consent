...
[![CDN](https://img.shields.io/badge/CDN-orange?style=flat&logo=jsdelivr&logoColor=white)](https://cdn.jsdelivr.net/gh/danielsitek/dgp-cookie-consent@1.5.0/dist/cookies.min.js)
...
1. Download the latest release or use CDN.
    ...
    ```
    https://cdn.jsdelivr.net/gh/danielsitek/dgp-cookie-consent@1.5.0/dist/cookies.min.js
    ```
